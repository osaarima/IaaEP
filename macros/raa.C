...
TString filePP[NPP] = {
	...
	"legotrain_JCIaa/data/JCIaaJt_legotrain_CF_pp_MC-515_20180427-1107-LHC17l3b_cent_woSDD.root",
	"legotrain_JCIaa/data/JCIaaJt_legotrain_CF_pp_MC-516_20180427-1107-LHC17l3b_cent_woSDD.root" 
};
...
TString commentPP[NPP] = {
	...
	"LHC17l3b_cent_woSDD_KineOnly:Jt",
	"LHC17l3b_cent_woSDD_Reco:Jt"
};
...
void LoadPP() {
	...
	for(int i=0;i<NPP;i++) {
		...
		if(i==0 || i==1 ) hiCentrpp = (TH1D *)fPP[0]->Get(Form("%s/AliJHistos/hiCentr",dirPP[0].Data()));
